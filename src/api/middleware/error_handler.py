...
_STATUS_MAP: dict[type[CommitCraftError], int] = {
...
def register_error_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(CommitCraftError)
    async def handle_domain_error(request: Request, exc: CommitCraftError) -> JSONResponse:
